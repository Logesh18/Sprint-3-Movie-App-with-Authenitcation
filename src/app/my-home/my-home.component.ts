...
import { faCaretDown,faTv,faEye,faHeart,faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
export class MyHomeComponent implements OnInit {
  ...
  caret=faCaretDown; tv=faTv; eye=faEye; heart=faHeart;signout=faSignOutAlt;
  i=0; handleError:any; movies:Details[]=[];j=0;initial:number=0;token='';
